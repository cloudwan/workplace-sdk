...
func (orderByFld *OrderByField) CompareWithDirection(left, right *VendorConnection) int {
...
func (orderBy *OrderBy) Sort(results VendorConnectionList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(VendorConnectionList))
}

func (orderBy *OrderBy) InsertSorted(sorted VendorConnectionList, elem *VendorConnection) (VendorConnectionList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(VendorConnectionList), elem.(*VendorConnection))
}

func (orderBy *OrderBy) Compare(left, right *VendorConnection) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*VendorConnection), right.(*VendorConnection))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseVendorConnection_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *VendorConnection_FieldMask {
	fieldMask := &VendorConnection_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == VendorConnection_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &VendorConnection_FieldTerminalPath{selector: VendorConnection_FieldPathSelectorName},
