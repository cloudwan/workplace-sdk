...
func (obj *Area) GotenValidate() error {
	if obj == nil {
		return nil
	}
	if subobj, ok := interface{}(obj.Geometry).(gotenvalidate.Validator); ok {
		if err := subobj.GotenValidate(); err != nil {
			return gotenvalidate.NewValidationError("Area", "geometry", obj.Geometry, "nested object validation failed", err)
		}
	}
	if subobj, ok := interface{}(obj.VendorSpec).(gotenvalidate.Validator); ok {
		if err := subobj.GotenValidate(); err != nil {
			return gotenvalidate.NewValidationError("Area", "vendorSpec", obj.VendorSpec, "nested object validation failed", err)
		}
	}
	if subobj, ok := interface{}(obj.Metadata).(gotenvalidate.Validator); ok {
		if err := subobj.GotenValidate(); err != nil {
			return gotenvalidate.NewValidationError("Area", "metadata", obj.Metadata, "nested object validation failed", err)
		}
	}
...
func (obj *Area_VendorSpec) GotenValidate() error {
	if obj == nil {
		return nil
	}
...
func (obj *Area_VendorSpec_PointGrab) GotenValidate() error {
	if obj == nil {
		return nil
	}
	if cvobj, ok := interface{}(obj).(gotenvalidate.CustomValidator); ok {
