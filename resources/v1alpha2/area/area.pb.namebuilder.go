...
const (
	NamePattern_Project_Region_Site_Building_Floor = "projects/{project}/regions/{region}/sites/{site}/buildings/{building}/floors/{floor}/areas/{area}"
)
		...
		nameObj: Name{
			...
			ParentName: ParentName{
				NamePattern: NamePattern{
					...
					Pattern: NamePattern_Project_Region_Site_Building_Floor,
				},
			},
		},
	}
