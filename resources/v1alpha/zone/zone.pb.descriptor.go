...
var (
	descriptor = &Descriptor{
		...
		nameDescriptor: gotenresource.NewNameDescriptor(
			...
			"pattern", "zoneId",
			[]string{"projectId", "siteId", "buildingId", "floorId", "areaId"},
			[]gotenresource.NamePattern{NamePattern_Project_Site, NamePattern_Project_Site_Building, NamePattern_Project_Site_Building_Floor, NamePattern_Project_Site_Building_Floor_Area}),
	}
)
