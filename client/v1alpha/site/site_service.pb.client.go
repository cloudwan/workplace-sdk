...
func (c *client) GetSite(ctx context.Context, in *GetSiteRequest, opts ...grpc.CallOption) (*site.Site, error) {
	out := new(site.Site)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.SiteService/GetSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetSites(ctx context.Context, in *BatchGetSitesRequest, opts ...grpc.CallOption) (*BatchGetSitesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.SiteService/BatchGetSites", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListSites(ctx context.Context, in *ListSitesRequest, opts ...grpc.CallOption) (*ListSitesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.SiteService/ListSites", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchSite(ctx context.Context, in *WatchSiteRequest, opts ...grpc.CallOption) (WatchSiteClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha.SiteService/WatchSite", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchSites(ctx context.Context, in *WatchSitesRequest, opts ...grpc.CallOption) (WatchSitesClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha.SiteService/WatchSites", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateSite(ctx context.Context, in *CreateSiteRequest, opts ...grpc.CallOption) (*site.Site, error) {
	out := new(site.Site)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.SiteService/CreateSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateSite(ctx context.Context, in *UpdateSiteRequest, opts ...grpc.CallOption) (*site.Site, error) {
	out := new(site.Site)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.SiteService/UpdateSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteSite(ctx context.Context, in *DeleteSiteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.SiteService/DeleteSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
