...
func (c *client) GetAgent(ctx context.Context, in *GetAgentRequest, opts ...grpc.CallOption) (*agent.Agent, error) {
	out := new(agent.Agent)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.AgentService/GetAgent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetAgents(ctx context.Context, in *BatchGetAgentsRequest, opts ...grpc.CallOption) (*BatchGetAgentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.AgentService/BatchGetAgents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListAgents(ctx context.Context, in *ListAgentsRequest, opts ...grpc.CallOption) (*ListAgentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.AgentService/ListAgents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchAgent(ctx context.Context, in *WatchAgentRequest, opts ...grpc.CallOption) (WatchAgentClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha.AgentService/WatchAgent", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchAgents(ctx context.Context, in *WatchAgentsRequest, opts ...grpc.CallOption) (WatchAgentsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha.AgentService/WatchAgents", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateAgent(ctx context.Context, in *CreateAgentRequest, opts ...grpc.CallOption) (*agent.Agent, error) {
	out := new(agent.Agent)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.AgentService/CreateAgent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateAgent(ctx context.Context, in *UpdateAgentRequest, opts ...grpc.CallOption) (*agent.Agent, error) {
	out := new(agent.Agent)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.AgentService/UpdateAgent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteAgent(ctx context.Context, in *DeleteAgentRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.AgentService/DeleteAgent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) Activation(ctx context.Context, opts ...grpc.CallOption) (ActivationClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha.AgentService/Activation", opts...)
	if err != nil {
		return nil, err
	}
