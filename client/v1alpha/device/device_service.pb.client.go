...
func (c *client) GetDevice(ctx context.Context, in *GetDeviceRequest, opts ...grpc.CallOption) (*device.Device, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.DeviceService/GetDevice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetDevices(ctx context.Context, in *BatchGetDevicesRequest, opts ...grpc.CallOption) (*BatchGetDevicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.DeviceService/BatchGetDevices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListDevices(ctx context.Context, in *ListDevicesRequest, opts ...grpc.CallOption) (*ListDevicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.DeviceService/ListDevices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchDevice(ctx context.Context, in *WatchDeviceRequest, opts ...grpc.CallOption) (WatchDeviceClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha.DeviceService/WatchDevice", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchDevices(ctx context.Context, in *WatchDevicesRequest, opts ...grpc.CallOption) (WatchDevicesClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha.DeviceService/WatchDevices", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateDevice(ctx context.Context, in *CreateDeviceRequest, opts ...grpc.CallOption) (*device.Device, error) {
	out := new(device.Device)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.DeviceService/CreateDevice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateDevice(ctx context.Context, in *UpdateDeviceRequest, opts ...grpc.CallOption) (*device.Device, error) {
	out := new(device.Device)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.DeviceService/UpdateDevice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteDevice(ctx context.Context, in *DeleteDeviceRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha.DeviceService/DeleteDevice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
