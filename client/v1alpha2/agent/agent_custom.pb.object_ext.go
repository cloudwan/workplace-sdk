...
func (o *ActivationRequest_Activate) MakeDiffFieldMask(other *ActivationRequest_Activate) *ActivationRequest_Activate_FieldMask {
	...
	}
	{
		...
		if subMask.IsFull() {
			...
			for _, subpath := range subMask.Paths {
				res.Paths = append(res.Paths, &ActivationRequestActivate_FieldSubPath{selector: ActivationRequestActivate_FieldPathSelectorAgent, subPath: subpath})
			}
		}
	}
	return res
