...
func (c *client) GetZone(ctx context.Context, in *GetZoneRequest, opts ...grpc.CallOption) (*zone.Zone, error) {
	out := new(zone.Zone)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha2.ZoneService/GetZone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetZones(ctx context.Context, in *BatchGetZonesRequest, opts ...grpc.CallOption) (*BatchGetZonesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha2.ZoneService/BatchGetZones", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListZones(ctx context.Context, in *ListZonesRequest, opts ...grpc.CallOption) (*ListZonesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha2.ZoneService/ListZones", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchZone(ctx context.Context, in *WatchZoneRequest, opts ...grpc.CallOption) (WatchZoneClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha2.ZoneService/WatchZone", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchZones(ctx context.Context, in *WatchZonesRequest, opts ...grpc.CallOption) (WatchZonesClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.workplace.v1alpha2.ZoneService/WatchZones", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateZone(ctx context.Context, in *CreateZoneRequest, opts ...grpc.CallOption) (*zone.Zone, error) {
	out := new(zone.Zone)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha2.ZoneService/CreateZone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateZone(ctx context.Context, in *UpdateZoneRequest, opts ...grpc.CallOption) (*zone.Zone, error) {
	out := new(zone.Zone)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha2.ZoneService/UpdateZone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteZone(ctx context.Context, in *DeleteZoneRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.workplace.v1alpha2.ZoneService/DeleteZone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
